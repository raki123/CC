...
def smproblog_instance_smproblog(string, sk):
...
if EFFICIENCY_BENCH:
    if SMPROBLOG:
        ...
        q5 = open("results/smproblog/smproblog_sddxd.log", 'w')
        p1 = multiprocessing.Process(target=launch,args=("results/smproblog/smproblog/results_ddnnf.csv", smproblog_bench_ddnnf, q1, 0))
        p2 = multiprocessing.Process(target=launch,args=("results/smproblog/aspmc/results.csv", smproblog_bench_aspmc, q2, 1))
        p3 = multiprocessing.Process(target=launch,args=("results/smproblog/clingo/results.csv", smproblog_bench_clingo, q3, 2))
        p4 = multiprocessing.Process(target=launch,args=("results/smproblog/smproblog/results_sddx.csv", smproblog_bench_sddx, q4, 3))
        p5 = multiprocessing.Process(target=launch,args=("results/smproblog/smproblog/results_sddxd.csv", smproblog_bench_sddxd, q5, 4))
