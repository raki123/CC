...
path(0,82):-edge(73,82),path(0,73).
...
path(0,84):-edge(75,84),path(0,75).
...
path(0,88):-edge(79,88),path(0,79).
...
path(0,87):-edge(78,87),path(0,78).
path(0,56):-edge(46,56),path(0,46).
path(0,55):-edge(54,55),path(0,54).
path(0,68):-edge(58,68),path(0,58).
path(0,81):-edge(72,81),path(0,72).
path(0,86):-edge(77,86),path(0,77).
path(0,89):-edge(80,89),path(0,80).
...
path(0,83):-edge(74,83),path(0,74).
...
path(0,85):-edge(76,85),path(0,76).
