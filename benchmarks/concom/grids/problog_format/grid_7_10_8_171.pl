...
path(0,67):-edge(60,67),path(0,60).
...
path(0,64):-edge(57,64),path(0,57).
...
path(0,66):-edge(59,66),path(0,59).
...
path(0,65):-edge(58,65),path(0,58).
path(0,61):-edge(53,61),path(0,53).
path(0,67):-edge(59,67),path(0,59).
path(0,69):-edge(62,69),path(0,62).
...
path(0,54):-edge(47,54),path(0,47).
...
path(0,61):-edge(54,61),path(0,54).
...
path(0,68):-edge(61,68),path(0,61).
