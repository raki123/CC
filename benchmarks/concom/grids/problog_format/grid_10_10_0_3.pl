...
path(0,98):-edge(88,98),path(0,88).
...
path(0,91):-edge(90,91),path(0,90).
...
path(0,93):-edge(82,93),path(0,82).
path(0,69):-edge(58,69),path(0,58).
path(0,91):-edge(80,91),path(0,80).
path(0,30):-edge(20,30),path(0,20).
path(0,61):-edge(51,61),path(0,51).
path(0,9):-edge(8,9),path(0,8).
path(0,96):-edge(86,96),path(0,86).
path(0,93):-edge(92,93),path(0,92).
path(0,50):-edge(40,50),path(0,40).
path(0,68):-edge(67,68),path(0,67).
path(0,83):-edge(82,83),path(0,82).
path(0,95):-edge(85,95),path(0,85).
path(0,99):-edge(98,99),path(0,98).
...
path(0,86):-edge(76,86),path(0,76).
path(0,94):-edge(93,94),path(0,93).
path(0,85):-edge(84,85),path(0,84).
...
path(0,87):-edge(77,87),path(0,77).
path(0,59):-edge(58,59),path(0,58).
path(0,79):-edge(78,79),path(0,78).
path(0,89):-edge(78,89),path(0,78).
...
path(0,85):-edge(74,85),path(0,74).
...
path(0,81):-edge(71,81),path(0,71).
...
path(0,97):-edge(96,97),path(0,96).
path(0,56):-edge(55,56),path(0,55).
path(0,83):-edge(72,83),path(0,72).
...
path(0,82):-edge(72,82),path(0,72).
...
path(0,84):-edge(73,84),path(0,73).
...
path(0,96):-edge(85,96),path(0,85).
...
path(0,83):-edge(73,83),path(0,73).
