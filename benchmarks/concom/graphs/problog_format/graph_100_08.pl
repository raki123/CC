...
path(0,15) :- path(0,9), edge(9,15).
path(0,15) :- path(0,4), edge(4,15).
path(0,99) :- path(0,15), edge(15,99).
path(0,99) :- path(0,88), edge(88,99).
...
path(0,88) :- path(0,40), edge(40,88).
path(0,88) :- path(0,61), edge(61,88).
path(0,8) :- path(0,4), edge(4,8).
path(0,8) :- path(0,2), edge(2,8).
path(0,61) :- path(0,4), edge(4,61).
path(0,61) :- path(0,2), edge(2,61).
path(0,5) :- path(0,3), edge(3,5).
path(0,5) :- edge(0,5).
path(0,23) :- path(0,5), edge(5,23).
path(0,23) :- edge(0,23).
evidence(path(0,99)).
