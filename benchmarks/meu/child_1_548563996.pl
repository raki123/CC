...
0.9::lVH :- body_2482(2481,lVH).
0.8::cardiacMixing("Complete") :- body_2492(2491,cardiacMixing("Complete")).
0.05::cO2("Low") :- body_2502(2501,cO2("Low")).
0.08::chestXray("Asy/Patch") :- body_2512(2511,chestXray("Asy/Patch")).
0.05::hypDistrib("Unequal") :- body_2522(2521,hypDistrib("Unequal")).
