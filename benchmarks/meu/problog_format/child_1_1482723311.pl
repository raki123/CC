...
utility(\+(ductFlow("None")),38).
utility(grunting,49).
utility(\+(grunting),-9).
utility(lVHreport,-31).
utility(\+(lVHreport),-10).
...
utility(\+(xrayReport("Grd_Glass")),25).
utility(birthAsphyxia,-45).
utility(\+(birthAsphyxia),6).
utility(\+(cO2("Low")),19).
utility(disease("PAIVS"),33).
utility(hypDistrib("Equal"),32).
utility(\+(hypDistrib("Equal")),-7).
utility(chestXray("Plethoric"),-21).
utility(\+(chestXray("Plethoric")),-5).
utility(disease("TAPVD"),4).
utility(lungFlow("High"),-7).
utility(\+(lungFlow("High")),-48).
utility(age("0-3_days"),28).
utility(\+(age("0-3_days")),31).
utility(\+(hypoxiaInO2("Mild")),-39).
utility(age("11-30_days"),6).
utility(\+(age("11-30_days")),38).
utility(cO2("High"),4).
utility(lVH,49).
...
utility(\+(xrayReport("Oligaemic")),24).
utility(rUQO2("5-12"),-6).
utility(\+(rUQO2("5-12")),-45).
utility(rUQO2("<5"),15).
utility(ductFlow("Lt_to_Rt"),10).
utility(\+(ductFlow("Lt_to_Rt")),-2).
...
utility(\+(xrayReport("Asy/Patchy")),-34).
utility(\+(disease("PFC")),-42).
utility(lungParench("Congested"),10).
utility(\+(cardiacMixing("None")),39).
utility(hypoxiaInO2("Severe"),28).
utility(\+(hypoxiaInO2("Severe")),15).
utility(lungFlow("Normal"),37).
utility(\+(lungFlow("Normal")),7).
utility(\+(age("4-10_days")),35).
utility(cardiacMixing("Complete"),-16).
utility(\+(cardiacMixing("Complete")),42).
...
0.9::lVH :- body_2492(2491,lVH).
0.7::sick :- body_2502(2501,sick).
0.1::cO2("High") :- body_2512(2511,cO2("High")).
0.4::grunting :- body_2522(2521,grunting).
0.7::hypoxiaInO2("Mild") :- body_2532(2531,hypoxiaInO2("Mild")).
0.2::xrayReport("Asy/Patchy") :- body_2542(2541,xrayReport("Asy/Patchy")).
0.9::cO2Report("<7.5") :- body_2552(2551,cO2Report("<7.5")).
0.3::rUQO2("<5") :- body_2562(2561,rUQO2("<5")).
