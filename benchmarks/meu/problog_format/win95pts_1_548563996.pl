...
utility(\+(grphcsRltdDrvrSttngs("Correct")),3).
utility(\+(incmpltPS),-20).
utility(prtDriver,26).
utility(\+(prtDriver),-13).
utility(problem2("Too_Long"),-47).
utility(hrglssDrtnAftrPrnt("Too_Long"),-29).
utility(\+(hrglssDrtnAftrPrnt("Too_Long")),-44).
...
utility(\+(grphcsRltdDrvrSttngs("Incorrect")),-9).
utility(prtData,34).
