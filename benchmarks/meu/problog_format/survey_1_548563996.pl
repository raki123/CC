...
0.5::algebraic_atom(1,1,0,set(none),e("uni"),"0.25").
0.6::algebraic_atom(2,0,0,set(none),e("high"),"0.64").
...
0.5::algebraic_atom(6,0,0,set(none),e("high"),"0.9").
0.7::algebraic_atom(6,1,0,set(none),e("uni"),"0.1").
...
0.9::algebraic_atom(9,0,0,set(none),r("small"),"0.25").
0.7::algebraic_atom(9,1,0,set(none),r("big"),"0.75").
0.7::algebraic_atom(10,0,0,set(none),r("small"),"0.2").
0.2::algebraic_atom(10,1,0,set(none),r("big"),"0.8").
...
0.9::algebraic_atom(13,0,0,set(none),t("car"),"0.56").
...
0.2::algebraic_atom(17,0,0,set(none),t("train"),"0.24").
utility(s("F"), -25).
utility(\+s("F"), -30).
utility(e("high"), 22).
utility(\+e("high"), -8).
