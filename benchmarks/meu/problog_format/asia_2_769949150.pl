...
0.1::lung :- body_644(643,lung).
0.01::lung :- body_652(651,lung).
0.05::tub :- body_660(659,tub).
0.01::tub :- body_668(667,tub).
0.6::bronc :- body_676(675,bronc).
0.3::bronc :- body_684(683,bronc).
0.0::either :- body_692(691,either).
0.98::xray :- body_700(699,xray).
0.05::xray :- body_708(707,xray).
0.9::dysp :- body_716(715,dysp).
0.8::dysp :- body_724(723,dysp).
0.7::dysp :- body_732(731,dysp).
0.1::dysp :- body_740(739,dysp).
0.05::xray :- body_752(751,xray).
