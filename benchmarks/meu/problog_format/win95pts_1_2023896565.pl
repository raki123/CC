...
utility(\+(scrnFntNtPrntrFnt),40).
utility(problem1("Normal_Output"),34).
utility(\+(problem1("Normal_Output")),18).
utility(tTOK,0).
utility(\+(tTOK),42).
utility(\+(drvSet("Incorrect")),-43).
utility(prntPrcssTm("Fast_Enough"),18).
utility(\+(hrglssDrtnAftrPrnt("Fast_Enough")),-9).
utility(dSApplctn("Windows"),20).
utility(prtMpTPth("Correct"),45).
utility(dS_NTOK,4).
utility(dataFile("Incorrect_Corrupt"),-11).
utility(\+(dataFile("Incorrect_Corrupt")),13).
...
utility(lclGrbld,38).
utility(\+(fntInstlltn("Verified")),-31).
...
utility(\+(tnrSpply("Low")),22).
utility(\+(prtStatToner("Low__None")),44).
utility(\+(prtCbl("Loose")),-17).
utility(drvOK("Corrupt"),47).
utility(\+(dataFile("Correct")),-9).
utility(nnPSGrphc,-4).
utility(\+(nnPSGrphc),2).
