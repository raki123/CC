...
utility(\+(grphcsRltdDrvrSttngs("Correct")),-40).
utility(incmpltPS,-41).
utility(\+(incmpltPS),-43).
utility(prtDriver,-12).
utility(\+(prtDriver),-46).
utility(problem2("Too_Long"),-41).
utility(\+(problem2("Too_Long")),-33).
utility(problem1("Normal_Output"),25).
utility(\+(problem1("Normal_Output")),48).
utility(tTOK,33).
...
utility(\+(appData("Correct")),12).
utility(prtPort,34).
utility(\+(prtPort),31).
utility(\+(rEPEAT("No__Different_Each_Time_")),-15).
utility(\+(appOK("Correct")),50).
utility(cblPrtHrdwrOK("Operational"),-9).
utility(\+(cblPrtHrdwrOK("Operational")),42).
utility(pSERRMEM("Low_Memory"),-41).
utility(\+(pSERRMEM("Low_Memory")),-13).
utility(ntwrkCnfg("Correct"),23).
utility(\+(ntwrkCnfg("Correct")),-17).
utility(grbldOtpt,25).
utility(\+(grbldOtpt),-17).
utility(prtData,-26).
utility(\+(prtData),27).
...
utility(\+(ePSGrphc("No____TIF___WMF___BMP_")),42).
...
utility(\+(fntInstlltn("Faulty")),41).
utility(ntwrkCnfg("Incorrect"),7).
utility(pSERRMEM("No_Error"),-13).
utility(\+(pSERRMEM("No_Error")),-49).
