...
utility(\+(ductFlow("Rt_to_Lt")),1).
utility(lowerBodyO2("12+"),0).
utility(\+(lowerBodyO2("12+")),35).
utility(disease("Fallot"),3).
utility(\+(disease("Fallot")),-37).
utility(cardiacMixing("Transp."),-17).
utility(\+(cardiacMixing("Transp.")),35).
...
utility(\+(xrayReport("Plethoric")),-41).
utility(chestXray("Oligaemic"),31).
utility(\+(chestXray("Oligaemic")),-41).
utility(cO2Report("<7.5"),10).
utility(disease("TGA"),-24).
utility(\+(disease("TGA")),-40).
...
utility(\+(lowerBodyO2("<5")),39).
utility(\+(xrayReport("Normal")),-17).
...
utility(\+(hypoxiaInO2("Severe")),24).
utility(lungFlow("Normal"),-7).
utility(\+(lungFlow("Normal")),-49).
utility(age("4-10_days"),31).
utility(\+(age("4-10_days")),40).
...
0.15::cardiacMixing("Complete") :- body_2492(2491,cardiacMixing("Complete")).
0.01::cardiacMixing("None") :- body_2502(2501,cardiacMixing("None")).
0.2::age("4-10_days") :- body_2512(2511,age("4-10_days")).
0.05::cO2("Low") :- body_2522(2521,cO2("Low")).
0.45::cO2("Normal") :- body_2532(2531,cO2("Normal")).
0.05::grunting :- body_2542(2541,grunting).
0.8::grunting :- body_2552(2551,grunting).
0.05::chestXray("Grd_Glass") :- body_2562(2561,chestXray("Grd_Glass")).
0.95::hypDistrib("Equal") :- body_2572(2571,hypDistrib("Equal")).
0.9::cO2Report("<7.5") :- body_2582(2581,cO2Report("<7.5")).
