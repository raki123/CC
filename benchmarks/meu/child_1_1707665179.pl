...
utility(\+(chestXray("Grd_Glass")),-19).
...
0.95::cardiacMixing("Complete") :- body_2482(2481,cardiacMixing("Complete")).
0.3::sick :- body_2492(2491,sick).
0.3::lungFlow("Normal") :- body_2502(2501,lungFlow("Normal")).
0.0::ductFlow("Rt_to_Lt") :- body_2512(2511,ductFlow("Rt_to_Lt")).
0.0::ductFlow("None") :- body_2522(2521,ductFlow("None")).
0.33::ductFlow("Lt_to_Rt") :- body_2532(2531,ductFlow("Lt_to_Rt")).
0.05::hypoxiaInO2("Moderate") :- body_2542(2541,hypoxiaInO2("Moderate")).
0.2::hypoxiaInO2("Severe") :- body_2552(2551,hypoxiaInO2("Severe")).
0.4::hypoxiaInO2("Severe") :- body_2562(2561,hypoxiaInO2("Severe")).
0.79::chestXray("Plethoric") :- body_2572(2571,chestXray("Plethoric")).
0.08::chestXray("Plethoric") :- body_2582(2581,chestXray("Plethoric")).
0.5::lowerBodyO2("<5") :- body_2592(2591,lowerBodyO2("<5")).
