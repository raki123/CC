...
trusts(12,6).
buys(7) :- viral(7,15),buys(15).
buys(10) :- viral(10,1),buys(1).
buys(17) :- viral(17,6),buys(6).
buys(14) :- viral(14,4),buys(4).
trusts(17,2).
buys(5) :- viral(5,13),buys(13).
trusts(16,12).
