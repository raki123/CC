...
utility(\+(grphcsRltdDrvrSttngs("Correct")),-31).
utility(incmpltPS,17).
utility(\+(prtDriver),48).
utility(hrglssDrtnAftrPrnt("Too_Long"),-49).
utility(\+(hrglssDrtnAftrPrnt("Too_Long")),36).
...
utility(\+(problem2("OK")),-29).
utility(\+(prtStatToner("No_Error")),-49).
utility(prtThread("Corrupt_Buggy"),22).
utility(prntPrcssTm("Too_Long"),-3).
utility(\+(prntPrcssTm("Too_Long")),48).
utility(\+(fntInstlltn("Faulty")),-28).
...
utility(\+(fllCrrptdBffr("Intact__not_Corrupt_")),13).
utility(prtPaper("Has_Paper"),-17).
utility(\+(prtPaper("Has_Paper")),19).
utility(prtSel,7).
