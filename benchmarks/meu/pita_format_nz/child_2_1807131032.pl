...
0.4::algebraic_atom(114,0,0,set(none),cardiacMixing("Mild"),"0.09").
0.4::algebraic_atom(115,0,0,set(none),lVHreport,"0.9").
0.4::algebraic_atom(116,0,0,set(none),cO2("High"),"0.3").
0.4::algebraic_atom(117,0,0,set(none),hypoxiaInO2("Severe"),"0.1").
0.4::algebraic_atom(118,0,0,set(none),hypoxiaInO2("Severe"),"0.8").
0.4::algebraic_atom(119,0,0,set(none),chestXray("Plethoric"),"0.15").
0.4::algebraic_atom(120,0,0,set(none),hypDistrib("Unequal"),"0.05").
0.4::algebraic_atom(121,0,0,set(none),hypDistrib("Unequal"),"0.05").
0.4::algebraic_atom(122,0,0,set(none),lowerBodyO2("5-12"),"0.6").
