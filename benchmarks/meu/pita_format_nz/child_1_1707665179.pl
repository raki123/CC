...
0.4::algebraic_atom(113,0,0,set(none),cardiacMixing("Complete"),"0.95").
0.4::algebraic_atom(114,0,0,set(none),sick,"0.3").
0.4::algebraic_atom(115,0,0,set(none),lungFlow("Normal"),"0.3").
0.4::algebraic_atom(116,0,0,set(none),ductFlow("Rt_to_Lt"),"0.0").
0.4::algebraic_atom(117,0,0,set(none),ductFlow("None"),"0.0").
0.4::algebraic_atom(118,0,0,set(none),ductFlow("Lt_to_Rt"),"0.33").
0.4::algebraic_atom(119,0,0,set(none),hypoxiaInO2("Moderate"),"0.05").
0.4::algebraic_atom(120,0,0,set(none),hypoxiaInO2("Severe"),"0.2").
0.4::algebraic_atom(121,0,0,set(none),hypoxiaInO2("Severe"),"0.4").
0.4::algebraic_atom(122,0,0,set(none),chestXray("Plethoric"),"0.79").
0.4::algebraic_atom(123,0,0,set(none),chestXray("Plethoric"),"0.08").
0.4::algebraic_atom(124,0,0,set(none),lowerBodyO2("<5"),"0.5").
