...
0.4::algebraic_atom(113,0,0,set(none),lVH,"0.05").
0.4::algebraic_atom(114,0,0,set(none),cardiacMixing("Complete"),"0.09").
0.4::algebraic_atom(115,0,0,set(none),ductFlow("None"),"0.05").
0.4::algebraic_atom(116,0,0,set(none),hypoxiaInO2("Moderate"),"0.18").
0.4::algebraic_atom(117,0,0,set(none),hypDistrib("Equal"),"0.95").
0.4::algebraic_atom(118,0,0,set(none),hypDistrib("Unequal"),"0.05").
0.4::algebraic_atom(119,0,0,set(none),xrayReport("Oligaemic"),"0.02").
0.4::algebraic_atom(120,0,0,set(none),lowerBodyO2("12+"),"0.6").
0.4::algebraic_atom(121,0,0,set(none),lowerBodyO2("<5"),"0.6").
