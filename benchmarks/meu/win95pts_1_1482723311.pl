...
utility(\+(tstpsTxt("x_1_Mb_Available_VM")),29).
utility(trTypFnts,49).
utility(\+(trTypFnts),-27).
utility(fllCrrptdBffr("Full_or_Corrupt"),7).
utility(\+(fllCrrptdBffr("Full_or_Corrupt")),50).
...
utility(\+(appOK("Correct")),-49).
utility(cblPrtHrdwrOK("Operational"),28).
utility(\+(cblPrtHrdwrOK("Operational")),44).
...
utility(\+(ePSGrphc("No____TIF___WMF___BMP_")),-29).
utility(drvOK("Reinstalled"),28).
utility(\+(drvOK("Reinstalled")),38).
utility(ntSpd("Slow"),49).
utility(\+(ntSpd("Slow")),-9).
utility(prtFile,-31).
utility(\+(prtFile),-10).
