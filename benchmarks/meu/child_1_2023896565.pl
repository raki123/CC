...
0.05102041::disease("TAPVD") :- body_2482(2481,disease("TAPVD")).
0.15::lungParench("Abnormal") :- body_2492(2491,lungParench("Abnormal")).
0.03::lungParench("Normal") :- body_2502(2501,lungParench("Normal")).
0.1::lVH :- body_2512(2511,lVH).
0.05::lungFlow("High") :- body_2522(2521,lungFlow("High")).
0.15::age("4-10_days") :- body_2532(2531,age("4-10_days")).
0.05::age("11-30_days") :- body_2542(2541,age("11-30_days")).
0.45::cO2("Normal") :- body_2552(2551,cO2("Normal")).
0.2::grunting :- body_2562(2561,grunting).
0.03::chestXray("Plethoric") :- body_2572(2571,chestXray("Plethoric")).
0.02::chestXray("Plethoric") :- body_2582(2581,chestXray("Plethoric")).
0.05::hypDistrib("Unequal") :- body_2592(2591,hypDistrib("Unequal")).
0.06::xrayReport("Asy/Patchy") :- body_2602(2601,xrayReport("Asy/Patchy")).
0.02::xrayReport("Grd_Glass") :- body_2612(2611,xrayReport("Grd_Glass")).
0.6::rUQO2("12+") :- body_2622(2621,rUQO2("12+")).
0.4::lowerBodyO2("5-12") :- body_2632(2631,lowerBodyO2("5-12")).
