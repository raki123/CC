...
0.1::lungParench("Normal") :- body_2492(2491,lungParench("Normal")).
0.1::lVH :- body_2502(2501,lVH).
0.1::lVH :- body_2512(2511,lVH).
0.15::ductFlow("Lt_to_Rt") :- body_2522(2521,ductFlow("Lt_to_Rt")).
0.1::hypoxiaInO2("Severe") :- body_2532(2531,hypoxiaInO2("Severe")).
0.03::chestXray("Oligaemic") :- body_2542(2541,chestXray("Oligaemic")).
0.02::chestXray("Plethoric") :- body_2552(2551,chestXray("Plethoric")).
0.05::chestXray("Normal") :- body_2562(2561,chestXray("Normal")).
0.15::chestXray("Oligaemic") :- body_2572(2571,chestXray("Oligaemic")).
