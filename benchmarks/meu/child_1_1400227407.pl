...
0.02::cardiacMixing("Transp.") :- body_2482(2481,cardiacMixing("Transp.")).
0.01::cardiacMixing("None") :- body_2492(2491,cardiacMixing("None")).
0.05::lungFlow("High") :- body_2502(2501,lungFlow("High")).
0.1::lungFlow("Low") :- body_2512(2511,lungFlow("Low")).
0.05::lVHreport :- body_2522(2521,lVHreport).
0.05::age("11-30_days") :- body_2532(2531,age("11-30_days")).
0.7::hypoxiaInO2("Moderate") :- body_2542(2541,hypoxiaInO2("Moderate")).
0.05::chestXray("Oligaemic") :- body_2552(2551,chestXray("Oligaemic")).
0.5::hypDistrib("Unequal") :- body_2562(2561,hypDistrib("Unequal")).
0.8::xrayReport("Oligaemic") :- body_2572(2571,xrayReport("Oligaemic")).
