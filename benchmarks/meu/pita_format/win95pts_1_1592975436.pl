...
utility(grphcsRltdDrvrSttngs("Correct"), 23).
utility(incmpltPS, 26).
utility(prtDriver, 45).
utility(hrglssDrtnAftrPrnt("Too_Long"), 11).
utility(scrnFntNtPrntrFnt, 50).
utility(problem1("Normal_Output"), -31).
utility(tTOK, 15).
utility(drvSet("Incorrect"), -29).
utility(prntPrcssTm("Fast_Enough"), -9).
utility(hrglssDrtnAftrPrnt("Fast_Enough"), 25).
utility(dSApplctn("Windows"), -2).
utility(prtMpTPth("Correct"), -29).
utility(dS_NTOK, -29).
utility(dataFile("Incorrect_Corrupt"), 9).
utility(pTROFFLINE("Online"), 38).
utility(prntngArOK("Correct"), 1).
utility(dSApplctn("DOS"), -2).
utility(eMFOK, 46).
utility(prtStatOff("No_Error"), -43).
utility(prtQueue("Short"), -11).
utility(netPrint("Yes__Network_printer_"), 21).
utility(prtTimeOut("Too_Short"), -40).
utility(netOK, -23).
utility(prntngArOK("Incorrect"), 0).
utility(prtSpool("Disabled"), 34).
utility(prtTimeOut("Long_Enough"), -50).
utility(prtSpool("Enabled"), 35).
utility(tstpsTxt("x_1_Mb_Available_VM"), 28).
utility(trTypFnts, 8).
utility(fllCrrptdBffr("Full_or_Corrupt"), 10).
utility(prtPath("Incorrect"), -17).
utility(prtPort, -15).
utility(rEPEAT("No__Different_Each_Time_"), -14).
utility(appOK("Correct"), 22).
utility(cblPrtHrdwrOK("Operational"), -6).
utility(pSERRMEM("Low_Memory"), -10).
utility(ntwrkCnfg("Correct"), 6).
utility(grphcsRltdDrvrSttngs("Incorrect"), 24).
utility(grbldOtpt, 19).
utility(prtData, 32).
utility(prtMpTPth("Incorrect"), 39).
utility(prtStatMem("Out_of_Memory"), 35).
utility(prtPScript, -15).
utility(ePSGrphc("No____TIF___WMF___BMP_"), -14).
utility(drvOK("Reinstalled"), 15).
utility(ntSpd("Slow"), -26).
utility(prtMem("Less_than_2Mb"), 1).
utility(dskLocal("Less_than_2_Mb"), -22).
utility(prtIcon("Normal"), -35).
utility(deskPrntSpd("OK"), 49).
utility(appDtGnTm("Too_Long"), 21).
utility(tstpsTxt("x_1_Mb_Available_VM2"), -18).
utility(prtPaper("No_Paper"), -34).
utility(fntInstlltn("Verified"), -27).
utility(appDtGnTm("Fast_Enough"), 11).
utility(prtStatMem("No_Error"), -49).
utility(dskLocal("Greater_than_2_Mb"), -16).
utility(deskPrntSpd("Too_Slow"), -25).
utility(drvSet("Correct"), -5).
utility(prtDataOut, 47).
utility(prtCbl("Connected"), -33).
utility(prtStatToner("No_Error"), 16).
utility(prntPrcssTm("Too_Long"), 12).
utility(ePSGrphc("Yes____EPS_"), 18).
utility(fntInstlltn("Faulty"), -23).
utility(cblPrtHrdwrOK("Not_Operational"), -47).
utility(ntwrkCnfg("Incorrect"), 28).
utility(pSERRMEM("No_Error"), 43).
utility(prtQueue("Long"), -7).
utility(problem3, -13).
utility(prtIcon("Grayed_Out"), -20).
utility(prtSel, -20).
utility(cmpltPgPrntd, 2).
utility(avlblVrtlMmry("Adequate____1Mb_"), -18).
utility(tnrSpply("Adequate"), -24).
utility(problem4, -8).
utility(pTROFFLINE("Offline"), 15).
utility(prtStatPaper("No_Error"), -30).
utility(grbldPS, 20).
utility(pgOrnttnOK("Incorrect"), 32).
utility(rEPEAT("Yes__Always_the_Same_"), 42).
utility(prtOn, 24).
utility(appData("Incorrect_or_corrupt"), 26).
utility(prntrAccptsTrtyp, -40).
utility(netPrint("No__Local_printer_"), -24).
utility(prtPath("Correct"), 15).
utility(ntGrbld, 41).
utility(prtStatOff("OFFLINE__OFF"), -32).
utility(tnrSpply("Low"), 7).
utility(prtStatToner("Low__None"), -2).
utility(prtCbl("Loose"), -49).
utility(drvOK("Corrupt"), -30).
utility(nnPSGrphc, -27).
utility(avlblVrtlMmry("Inadequate____1_Mb_"), 27).
utility(appOK("Incorrect_Corrupt"), 42).
