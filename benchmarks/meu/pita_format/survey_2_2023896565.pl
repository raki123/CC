...
? :: dec_1.
? :: dec_0.
0.8::algebraic_atom(0,0,0,set(none),a("young"),"0.3").
...
0.6::algebraic_atom(4,0,0,set(none),e("high"),"0.7").
...
0.5::algebraic_atom(11,0,0,set(none),t("car"),"0.48").
...
0.6::algebraic_atom(12,1,0,set(none),t("train"),"0.24").
...
0.7::algebraic_atom(17,0,0,set(none),o("self"),"0.08").
