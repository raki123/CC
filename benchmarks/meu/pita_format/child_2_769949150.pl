...
0.6::algebraic_atom(113,0,0,set(none),lungParench("Congested"),"0.6").
0.1::algebraic_atom(114,0,0,set(none),lVH,"0.1").
0.6::algebraic_atom(115,0,0,set(none),lungFlow("High"),"0.6").
1.0::algebraic_atom(116,0,0,set(none),ductFlow("Lt_to_Rt"),"1.0").
0.05::algebraic_atom(117,0,0,set(none),lVHreport,"0.05").
0.05::algebraic_atom(118,0,0,set(none),hypoxiaInO2("Moderate"),"0.05").
0.05::algebraic_atom(119,0,0,set(none),chestXray("Grd_Glass"),"0.05").
0.95::algebraic_atom(120,0,0,set(none),hypDistrib("Equal"),"0.95").
0.1::algebraic_atom(121,0,0,set(none),cO2Report("<7.5"),"0.1").
0.3::algebraic_atom(122,0,0,set(none),rUQO2("<5"),"0.3").
0.05::algebraic_atom(123,0,0,set(none),lowerBodyO2("12+"),"0.05").
0.6::algebraic_atom(124,0,0,set(none),lowerBodyO2("<5"),"0.6").
