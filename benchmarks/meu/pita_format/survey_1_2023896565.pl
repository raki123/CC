...
0.36::algebraic_atom(17,0,0,set(none),e("uni"),"0.36").
0.72::algebraic_atom(18,0,0,set(none),e("high"),"0.72").
0.88::algebraic_atom(19,0,0,set(none),e("high"),"0.88").
0.1::algebraic_atom(20,0,0,set(none),t("other"),"0.1").
utility(e("high"), 0).
utility(a("old"), 18).
utility(r("big"), 20).
utility(o("self"), 45).
