...
0.8::algebraic_atom(114,0,0,set(none),ductFlow("Lt_to_Rt"),"0.8").
0.05::algebraic_atom(115,0,0,set(none),grunting,"0.05").
0.4::algebraic_atom(116,0,0,set(none),hypoxiaInO2("Severe"),"0.4").
0.8::algebraic_atom(117,0,0,set(none),hypoxiaInO2("Severe"),"0.8").
0.7::algebraic_atom(118,0,0,set(none),chestXray("Grd_Glass"),"0.7").
0.95::algebraic_atom(119,0,0,set(none),hypDistrib("Equal"),"0.95").
0.1::algebraic_atom(120,0,0,set(none),gruntingReport,"0.1").
