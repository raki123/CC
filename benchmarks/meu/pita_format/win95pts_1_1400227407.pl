...
utility(grphcsRltdDrvrSttngs("Correct"), 44).
utility(incmpltPS, 37).
utility(prtDriver, 10).
utility(problem2("Too_Long"), -47).
utility(hrglssDrtnAftrPrnt("Too_Long"), 16).
utility(scrnFntNtPrntrFnt, -47).
utility(problem1("Normal_Output"), 39).
utility(tTOK, 15).
utility(prntPrcssTm("Fast_Enough"), -43).
utility(hrglssDrtnAftrPrnt("Fast_Enough"), -43).
utility(dSApplctn("Windows"), -5).
utility(prtMpTPth("Correct"), -3).
utility(gDIIN, 13).
utility(dS_NTOK, -3).
utility(dataFile("Incorrect_Corrupt"), -31).
utility(pTROFFLINE("Online"), 3).
utility(prntngArOK("Correct"), -21).
utility(dSApplctn("DOS"), -30).
utility(eMFOK, -3).
utility(prtStatOff("No_Error"), 11).
utility(prtQueue("Short"), 2).
utility(problem5, 0).
utility(prntngArOK("Incorrect"), -21).
utility(prtSpool("Disabled"), 6).
utility(dS_LCLOK, -38).
utility(prtTimeOut("Long_Enough"), 12).
utility(prtSpool("Enabled"), -12).
utility(tstpsTxt("x_1_Mb_Available_VM"), 46).
utility(trTypFnts, -15).
utility(fllCrrptdBffr("Full_or_Corrupt"), 45).
utility(prtPath("Incorrect"), 44).
utility(appData("Correct"), 31).
utility(prtPort, 31).
utility(rEPEAT("No__Different_Each_Time_"), -40).
utility(appOK("Correct"), 40).
utility(cblPrtHrdwrOK("Operational"), 0).
utility(ntwrkCnfg("Correct"), -16).
utility(grphcsRltdDrvrSttngs("Incorrect"), -42).
utility(grbldOtpt, -27).
utility(prtData, 1).
utility(prtMpTPth("Incorrect"), 29).
utility(prtStatMem("Out_of_Memory"), 44).
utility(prtPScript, 7).
utility(drvOK("Reinstalled"), -3).
utility(ntSpd("Slow"), 0).
utility(prtFile, -1).
utility(prtMem("Less_than_2Mb"), -41).
utility(pgOrnttnOK("Correct"), 4).
utility(problem1("No_Output"), 4).
utility(pSGRAPHIC, 0).
utility(prtMem("Greater_than_2_Mb"), -36).
utility(dskLocal("Less_than_2_Mb"), 15).
utility(prtIcon("Normal"), -43).
utility(ntSpd("OK"), -40).
utility(nnTTOK, 7).
utility(deskPrntSpd("OK"), 29).
utility(appDtGnTm("Too_Long"), 8).
utility(tstpsTxt("x_1_Mb_Available_VM2"), -17).
utility(prtPaper("No_Paper"), 50).
utility(fntInstlltn("Verified"), 12).
utility(appDtGnTm("Fast_Enough"), 50).
utility(prtStatMem("No_Error"), 17).
utility(prtThread("OK"), -10).
utility(dskLocal("Greater_than_2_Mb"), 35).
utility(deskPrntSpd("Too_Slow"), 45).
utility(drvSet("Correct"), -42).
utility(prtDataOut, 15).
utility(prtCbl("Connected"), 6).
utility(prtStatToner("No_Error"), 14).
utility(prntPrcssTm("Too_Long"), -44).
utility(fntInstlltn("Faulty"), 49).
utility(cblPrtHrdwrOK("Not_Operational"), 4).
utility(ntwrkCnfg("Incorrect"), -15).
utility(pSERRMEM("No_Error"), -42).
utility(prtQueue("Long"), 11).
utility(lclOK, 26).
utility(prtIcon("Grayed_Out"), 46).
utility(prtPaper("Has_Paper"), 35).
utility(prtSel, -18).
utility(cmpltPgPrntd, -34).
utility(tnrSpply("Adequate"), -24).
utility(problem4, -3).
utility(prtStatPaper("Jam__Out__Bin_Full"), -29).
utility(pTROFFLINE("Offline"), -25).
utility(prtStatPaper("No_Error"), 50).
utility(pgOrnttnOK("Incorrect"), 45).
utility(prtOn, -41).
utility(appData("Incorrect_or_corrupt"), -27).
utility(prntrAccptsTrtyp, -15).
utility(netPrint("No__Local_printer_"), -34).
utility(prtPath("Correct"), -15).
utility(ntGrbld, -21).
utility(prtStatOff("OFFLINE__OFF"), -50).
utility(prtCbl("Loose"), 18).
utility(drvOK("Corrupt"), 50).
utility(dataFile("Correct"), 44).
utility(nnPSGrphc, -13).
utility(avlblVrtlMmry("Inadequate____1_Mb_"), -15).
utility(gDIOUT, -33).
