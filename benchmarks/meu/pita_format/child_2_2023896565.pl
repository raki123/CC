...
0.25::algebraic_atom(114,0,0,set(none),lungParench("Congested"),"0.25").
...
0.3::algebraic_atom(119,0,0,set(none),lungFlow("Normal"),"0.3").
0.95::algebraic_atom(120,0,0,set(none),age("0-3_days"),"0.95").
0.05::algebraic_atom(121,0,0,set(none),hypoxiaInO2("Moderate"),"0.05").
0.5::algebraic_atom(122,0,0,set(none),hypoxiaInO2("Moderate"),"0.5").
0.05::algebraic_atom(123,0,0,set(none),hypDistrib("Unequal"),"0.05").
0.05::algebraic_atom(124,0,0,set(none),hypDistrib("Unequal"),"0.05").
0.5::algebraic_atom(125,0,0,set(none),hypDistrib("Unequal"),"0.5").
0.1::algebraic_atom(126,0,0,set(none),xrayReport("Normal"),"0.1").
0.8::algebraic_atom(127,0,0,set(none),gruntingReport,"0.8").
0.9::algebraic_atom(128,0,0,set(none),cO2Report("<7.5"),"0.9").
0.1::algebraic_atom(129,0,0,set(none),cO2Report("<7.5"),"0.1").
