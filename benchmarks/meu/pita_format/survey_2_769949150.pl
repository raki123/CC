...
0.1::algebraic_atom(15,0,0,set(none),s("M"),"0.6").
0.7::algebraic_atom(16,0,0,set(none),s("F"),"0.4").
0.7::algebraic_atom(17,0,0,set(none),e("uni"),"0.3").
0.1::algebraic_atom(18,0,0,set(none),o("emp"),"0.96").
0.9::algebraic_atom(19,0,0,set(none),t("train"),"0.36").
