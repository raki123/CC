...
utility(grphcsRltdDrvrSttngs("Correct"), -47).
utility(incmpltPS, -50).
utility(problem2("Too_Long"), 22).
utility(hrglssDrtnAftrPrnt("Too_Long"), -24).
utility(scrnFntNtPrntrFnt, -9).
utility(problem1("Normal_Output"), 34).
utility(tTOK, 0).
utility(prntPrcssTm("Fast_Enough"), 18).
utility(dSApplctn("Windows"), 20).
utility(prtMpTPth("Correct"), 45).
utility(dS_NTOK, 4).
utility(dataFile("Incorrect_Corrupt"), -11).
utility(pTROFFLINE("Online"), -32).
utility(prntngArOK("Correct"), -43).
utility(dSApplctn("DOS"), -30).
utility(eMFOK, 22).
utility(problem6, 38).
utility(prtStatOff("No_Error"), -35).
utility(netPrint("Yes__Network_printer_"), 7).
utility(prtTimeOut("Too_Short"), -46).
utility(prntngArOK("Incorrect"), -29).
utility(prtSpool("Disabled"), 10).
utility(dS_LCLOK, -5).
utility(prtTimeOut("Long_Enough"), 2).
utility(prtSpool("Enabled"), 19).
utility(trTypFnts, 3).
utility(fllCrrptdBffr("Full_or_Corrupt"), -33).
utility(prtPath("Incorrect"), -24).
utility(appData("Correct"), 28).
utility(rEPEAT("No__Different_Each_Time_"), 36).
utility(appOK("Correct"), 47).
utility(cblPrtHrdwrOK("Operational"), -48).
utility(pSERRMEM("Low_Memory"), 45).
utility(ntwrkCnfg("Correct"), 39).
utility(grphcsRltdDrvrSttngs("Incorrect"), -1).
utility(grbldOtpt, 43).
utility(prtData, 44).
utility(prtMpTPth("Incorrect"), -23).
utility(prtStatMem("Out_of_Memory"), -46).
utility(prtPScript, 24).
utility(ePSGrphc("No____TIF___WMF___BMP_"), 20).
utility(drvOK("Reinstalled"), -50).
utility(ntSpd("Slow"), -26).
utility(prtFile, -13).
utility(prtMem("Less_than_2Mb"), 42).
utility(pgOrnttnOK("Correct"), 16).
utility(pC2PRT, -19).
utility(problem1("No_Output"), 48).
utility(pSGRAPHIC, -1).
utility(prtMem("Greater_than_2_Mb"), -35).
utility(prtIcon("Normal"), 19).
utility(ntSpd("OK"), 44).
utility(nnTTOK, -4).
utility(tstpsTxt("x_1_Mb_Available_VM2"), 6).
utility(prtPaper("No_Paper"), 18).
utility(lclGrbld, 38).
utility(appDtGnTm("Fast_Enough"), 4).
utility(prtStatMem("No_Error"), -42).
utility(dskLocal("Greater_than_2_Mb"), -3).
utility(deskPrntSpd("Too_Slow"), -4).
utility(drvSet("Correct"), -43).
utility(problem2("OK"), -11).
utility(prtDataOut, -28).
utility(prtCbl("Connected"), -40).
utility(prtThread("Corrupt_Buggy"), -33).
utility(prntPrcssTm("Too_Long"), -19).
utility(ePSGrphc("Yes____EPS_"), -40).
utility(fntInstlltn("Faulty"), 36).
utility(ntwrkCnfg("Incorrect"), -46).
utility(pSERRMEM("No_Error"), 41).
utility(prtQueue("Long"), -12).
utility(problem3, -30).
utility(lclOK, 6).
utility(prtIcon("Grayed_Out"), 26).
utility(fllCrrptdBffr("Intact__not_Corrupt_"), 47).
utility(prtPaper("Has_Paper"), 20).
utility(prtSel, -7).
utility(cmpltPgPrntd, -23).
utility(avlblVrtlMmry("Adequate____1Mb_"), -36).
utility(tnrSpply("Adequate"), 36).
utility(problem4, -46).
utility(prtStatPaper("Jam__Out__Bin_Full"), 14).
utility(pTROFFLINE("Offline"), -6).
utility(prtStatPaper("No_Error"), -10).
utility(grbldPS, 12).
utility(pgOrnttnOK("Incorrect"), 2).
utility(rEPEAT("Yes__Always_the_Same_"), -48).
utility(prtOn, -48).
utility(appData("Incorrect_or_corrupt"), 18).
utility(prntrAccptsTrtyp, -3).
utility(netPrint("No__Local_printer_"), -19).
utility(prtPath("Correct"), -2).
utility(ntGrbld, -30).
utility(prtStatOff("OFFLINE__OFF"), 8).
utility(tnrSpply("Low"), -11).
utility(drvOK("Corrupt"), 47).
utility(nnPSGrphc, -4).
utility(avlblVrtlMmry("Inadequate____1_Mb_"), -31).
utility(gDIOUT, 11).
utility(appOK("Incorrect_Corrupt"), 48).
