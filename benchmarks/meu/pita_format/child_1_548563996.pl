...
0.9::algebraic_atom(113,0,0,set(none),lVH,"0.9").
0.8::algebraic_atom(114,0,0,set(none),cardiacMixing("Complete"),"0.8").
0.05::algebraic_atom(115,0,0,set(none),cO2("Low"),"0.05").
0.08::algebraic_atom(116,0,0,set(none),chestXray("Asy/Patch"),"0.08").
0.05::algebraic_atom(117,0,0,set(none),hypDistrib("Unequal"),"0.05").
