...
utility(grphcsRltdDrvrSttngs("Correct"), 0).
utility(problem2("Too_Long"), -37).
utility(hrglssDrtnAftrPrnt("Too_Long"), -46).
utility(scrnFntNtPrntrFnt, 22).
utility(problem1("Normal_Output"), 21).
utility(tTOK, 27).
utility(prntPrcssTm("Fast_Enough"), 44).
utility(hrglssDrtnAftrPrnt("Fast_Enough"), -21).
utility(prtMpTPth("Correct"), 13).
utility(gDIIN, 32).
utility(dS_NTOK, 32).
utility(dataFile("Incorrect_Corrupt"), 41).
utility(pTROFFLINE("Online"), -20).
utility(eMFOK, 46).
utility(problem6, -2).
utility(prtStatOff("No_Error"), 50).
utility(prtQueue("Short"), 3).
utility(netPrint("Yes__Network_printer_"), -22).
utility(prtTimeOut("Too_Short"), 37).
utility(problem5, 7).
utility(netOK, -13).
utility(prtSpool("Disabled"), -24).
utility(dS_LCLOK, -45).
utility(prtTimeOut("Long_Enough"), -47).
utility(prtSpool("Enabled"), -22).
utility(tstpsTxt("x_1_Mb_Available_VM"), 39).
utility(fllCrrptdBffr("Full_or_Corrupt"), 35).
utility(prtPath("Incorrect"), 18).
utility(appData("Correct"), -3).
utility(rEPEAT("No__Different_Each_Time_"), -15).
utility(cblPrtHrdwrOK("Operational"), -40).
utility(pSERRMEM("Low_Memory"), -35).
utility(ntwrkCnfg("Correct"), 47).
utility(grbldOtpt, 9).
utility(prtData, -5).
utility(prtMpTPth("Incorrect"), 47).
utility(prtStatMem("Out_of_Memory"), -20).
utility(ePSGrphc("No____TIF___WMF___BMP_"), 16).
utility(drvOK("Reinstalled"), 46).
utility(ntSpd("Slow"), 6).
utility(prtMem("Less_than_2Mb"), -31).
utility(pC2PRT, -9).
utility(problem1("No_Output"), -41).
utility(pSGRAPHIC, -31).
utility(prtMem("Greater_than_2_Mb"), 31).
utility(dskLocal("Less_than_2_Mb"), -16).
utility(prtIcon("Normal"), 12).
utility(ntSpd("OK"), -8).
utility(nnTTOK, 28).
utility(deskPrntSpd("OK"), -11).
utility(appDtGnTm("Too_Long"), 13).
utility(tstpsTxt("x_1_Mb_Available_VM2"), -37).
utility(prtPaper("No_Paper"), 47).
utility(lclGrbld, -28).
utility(appDtGnTm("Fast_Enough"), -42).
utility(prtThread("OK"), 16).
utility(dskLocal("Greater_than_2_Mb"), 21).
utility(deskPrntSpd("Too_Slow"), 10).
utility(drvSet("Correct"), 34).
utility(problem2("OK"), -44).
utility(prtDataOut, -24).
utility(prtCbl("Connected"), 36).
utility(prtStatToner("No_Error"), -27).
utility(prntPrcssTm("Too_Long"), -2).
utility(ePSGrphc("Yes____EPS_"), 6).
utility(fntInstlltn("Faulty"), 29).
utility(pSERRMEM("No_Error"), 18).
utility(problem3, 36).
utility(lclOK, 34).
utility(prtIcon("Grayed_Out"), -48).
utility(cmpltPgPrntd, -29).
utility(avlblVrtlMmry("Adequate____1Mb_"), -30).
utility(tnrSpply("Adequate"), 45).
utility(prtStatPaper("Jam__Out__Bin_Full"), 33).
utility(prtStatPaper("No_Error"), 18).
utility(pgOrnttnOK("Incorrect"), 39).
utility(rEPEAT("Yes__Always_the_Same_"), -29).
utility(prtOn, 36).
utility(appData("Incorrect_or_corrupt"), 24).
utility(netPrint("No__Local_printer_"), -14).
utility(prtPath("Correct"), -23).
utility(ntGrbld, -24).
utility(prtStatOff("OFFLINE__OFF"), 12).
utility(tnrSpply("Low"), -42).
utility(prtStatToner("Low__None"), -41).
utility(prtCbl("Loose"), 14).
utility(drvOK("Corrupt"), 24).
utility(dataFile("Correct"), 28).
utility(nnPSGrphc, -3).
utility(avlblVrtlMmry("Inadequate____1_Mb_"), 20).
utility(gDIOUT, 23).
utility(appOK("Incorrect_Corrupt"), -5).
