...
utility(problem2("Too_Long"), -25).
utility(hrglssDrtnAftrPrnt("Too_Long"), 1).
utility(scrnFntNtPrntrFnt, 17).
utility(tTOK, -8).
utility(drvSet("Incorrect"), 7).
utility(dSApplctn("Windows"), 2).
utility(prtMpTPth("Correct"), 39).
utility(dS_NTOK, 18).
utility(dataFile("Incorrect_Corrupt"), 33).
utility(pTROFFLINE("Online"), -20).
utility(prntngArOK("Correct"), 12).
utility(dSApplctn("DOS"), -28).
utility(eMFOK, 20).
utility(problem6, 22).
utility(prtStatOff("No_Error"), 7).
utility(prtTimeOut("Too_Short"), -20).
utility(prntngArOK("Incorrect"), -13).
utility(prtSpool("Disabled"), 23).
utility(dS_LCLOK, 35).
utility(prtSpool("Enabled"), -14).
utility(tstpsTxt("x_1_Mb_Available_VM"), -6).
utility(trTypFnts, 49).
utility(fllCrrptdBffr("Full_or_Corrupt"), 7).
utility(prtPath("Incorrect"), 7).
utility(appData("Correct"), 50).
utility(prtPort, 46).
utility(rEPEAT("No__Different_Each_Time_"), 22).
utility(appOK("Correct"), 5).
utility(cblPrtHrdwrOK("Operational"), 28).
utility(pSERRMEM("Low_Memory"), -48).
utility(ntwrkCnfg("Correct"), -46).
utility(grphcsRltdDrvrSttngs("Incorrect"), -28).
utility(grbldOtpt, -41).
utility(prtData, -44).
utility(prtMpTPth("Incorrect"), 48).
utility(prtPScript, 39).
utility(ePSGrphc("No____TIF___WMF___BMP_"), 14).
utility(drvOK("Reinstalled"), 28).
utility(ntSpd("Slow"), 49).
utility(prtFile, -31).
utility(prtMem("Less_than_2Mb"), 11).
utility(pgOrnttnOK("Correct"), 6).
utility(pC2PRT, -15).
utility(pSGRAPHIC, -7).
utility(prtMem("Greater_than_2_Mb"), -24).
utility(dskLocal("Less_than_2_Mb"), 29).
utility(prtIcon("Normal"), -32).
utility(ntSpd("OK"), 33).
utility(nnTTOK, 6).
utility(deskPrntSpd("OK"), -45).
utility(prtPaper("No_Paper"), 33).
utility(lclGrbld, 32).
utility(fntInstlltn("Verified"), -21).
utility(prtStatMem("No_Error"), 4).
utility(prtThread("OK"), -7).
utility(dskLocal("Greater_than_2_Mb"), 28).
utility(problem2("OK"), 6).
utility(prtDataOut, 4).
utility(prtCbl("Connected"), 49).
utility(prtStatToner("No_Error"), -14).
utility(prtThread("Corrupt_Buggy"), -43).
utility(prntPrcssTm("Too_Long"), -24).
utility(ePSGrphc("Yes____EPS_"), -1).
utility(fntInstlltn("Faulty"), 21).
utility(cblPrtHrdwrOK("Not_Operational"), -6).
utility(ntwrkCnfg("Incorrect"), 15).
utility(pSERRMEM("No_Error"), 10).
utility(prtQueue("Long"), 9).
utility(problem3, -45).
utility(lclOK, 25).
utility(prtIcon("Grayed_Out"), 33).
utility(fllCrrptdBffr("Intact__not_Corrupt_"), -23).
utility(prtPaper("Has_Paper"), -38).
utility(cmpltPgPrntd, 10).
utility(tnrSpply("Adequate"), 28).
utility(problem4, 37).
utility(pTROFFLINE("Offline"), -16).
utility(pgOrnttnOK("Incorrect"), 45).
utility(prtOn, 7).
utility(appData("Incorrect_or_corrupt"), 26).
utility(prntrAccptsTrtyp, -27).
utility(netPrint("No__Local_printer_"), -14).
utility(prtPath("Correct"), -2).
utility(ntGrbld, 15).
utility(prtStatOff("OFFLINE__OFF"), -12).
utility(tnrSpply("Low"), 26).
utility(prtStatToner("Low__None"), 41).
utility(prtCbl("Loose"), -49).
utility(nnPSGrphc, 47).
utility(avlblVrtlMmry("Inadequate____1_Mb_"), 28).
utility(gDIOUT, 36).
utility(appOK("Incorrect_Corrupt"), -50).
