...
utility(grphcsRltdDrvrSttngs("Correct"), 28).
utility(incmpltPS, -41).
utility(prtDriver, -12).
utility(problem2("Too_Long"), -41).
utility(problem1("Normal_Output"), 25).
utility(tTOK, 33).
utility(drvSet("Incorrect"), -1).
utility(prntPrcssTm("Fast_Enough"), 45).
utility(hrglssDrtnAftrPrnt("Fast_Enough"), -14).
utility(dSApplctn("Windows"), 22).
utility(dS_NTOK, 35).
utility(pTROFFLINE("Online"), -4).
utility(prntngArOK("Correct"), 39).
utility(dSApplctn("DOS"), 29).
utility(problem6, 12).
utility(prtStatOff("No_Error"), -17).
utility(prtQueue("Short"), 14).
utility(prtTimeOut("Too_Short"), -31).
utility(problem5, -17).
utility(netOK, 37).
utility(prntngArOK("Incorrect"), 10).
utility(prtSpool("Disabled"), -20).
utility(dS_LCLOK, -25).
utility(prtTimeOut("Long_Enough"), -43).
utility(prtSpool("Enabled"), -23).
utility(tstpsTxt("x_1_Mb_Available_VM"), 39).
utility(trTypFnts, -26).
utility(fllCrrptdBffr("Full_or_Corrupt"), 40).
utility(prtPath("Incorrect"), -16).
utility(appData("Correct"), 35).
utility(prtPort, 34).
utility(cblPrtHrdwrOK("Operational"), -9).
utility(pSERRMEM("Low_Memory"), -41).
utility(ntwrkCnfg("Correct"), 23).
utility(grbldOtpt, 25).
utility(prtData, -26).
utility(prtStatMem("Out_of_Memory"), 6).
utility(prtPScript, -27).
utility(ePSGrphc("No____TIF___WMF___BMP_"), 24).
utility(drvOK("Reinstalled"), -15).
utility(prtFile, 44).
utility(prtMem("Less_than_2Mb"), -36).
utility(pgOrnttnOK("Correct"), 36).
utility(pC2PRT, -12).
utility(problem1("No_Output"), -34).
utility(pSGRAPHIC, 19).
utility(dskLocal("Less_than_2_Mb"), -15).
utility(ntSpd("OK"), -45).
utility(nnTTOK, 12).
utility(deskPrntSpd("OK"), -23).
utility(appDtGnTm("Too_Long"), -42).
utility(tstpsTxt("x_1_Mb_Available_VM2"), 40).
utility(prtPaper("No_Paper"), -6).
utility(lclGrbld, 49).
utility(fntInstlltn("Verified"), 1).
utility(appDtGnTm("Fast_Enough"), -34).
utility(prtStatMem("No_Error"), 13).
utility(prtThread("OK"), -43).
utility(dskLocal("Greater_than_2_Mb"), -8).
utility(deskPrntSpd("Too_Slow"), 39).
utility(drvSet("Correct"), -28).
utility(problem2("OK"), 39).
utility(prtDataOut, 8).
utility(prtCbl("Connected"), -6).
utility(prtThread("Corrupt_Buggy"), -33).
utility(prntPrcssTm("Too_Long"), 37).
utility(fntInstlltn("Faulty"), -14).
utility(ntwrkCnfg("Incorrect"), 7).
utility(pSERRMEM("No_Error"), -13).
utility(prtQueue("Long"), 31).
utility(problem3, 3).
utility(lclOK, -10).
utility(prtIcon("Grayed_Out"), -31).
utility(fllCrrptdBffr("Intact__not_Corrupt_"), 43).
utility(cmpltPgPrntd, 40).
utility(avlblVrtlMmry("Adequate____1Mb_"), 15).
utility(tnrSpply("Adequate"), -7).
utility(problem4, -4).
utility(pTROFFLINE("Offline"), 50).
utility(prtStatPaper("No_Error"), -30).
utility(grbldPS, -26).
utility(pgOrnttnOK("Incorrect"), 35).
utility(rEPEAT("Yes__Always_the_Same_"), 7).
utility(prtOn, 31).
utility(appData("Incorrect_or_corrupt"), 39).
utility(prntrAccptsTrtyp, 43).
utility(prtPath("Correct"), 18).
utility(prtStatOff("OFFLINE__OFF"), -18).
utility(tnrSpply("Low"), 42).
utility(prtStatToner("Low__None"), 24).
utility(prtCbl("Loose"), 31).
utility(dataFile("Correct"), 45).
utility(nnPSGrphc, -25).
utility(avlblVrtlMmry("Inadequate____1_Mb_"), 31).
utility(appOK("Incorrect_Corrupt"), -30).
