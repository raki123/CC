...
utility(incmpltPS, 17).
utility(hrglssDrtnAftrPrnt("Too_Long"), -49).
utility(scrnFntNtPrntrFnt, -8).
utility(problem1("Normal_Output"), -17).
utility(tTOK, -8).
utility(drvSet("Incorrect"), 33).
utility(prntPrcssTm("Fast_Enough"), -23).
utility(hrglssDrtnAftrPrnt("Fast_Enough"), -10).
utility(dSApplctn("Windows"), -34).
utility(prtMpTPth("Correct"), -8).
utility(gDIIN, -19).
utility(dS_NTOK, 17).
utility(dataFile("Incorrect_Corrupt"), 26).
utility(pTROFFLINE("Online"), -13).
utility(prntngArOK("Correct"), -3).
utility(eMFOK, -31).
utility(prtStatOff("No_Error"), 2).
utility(netPrint("Yes__Network_printer_"), 24).
utility(prtTimeOut("Too_Short"), 45).
utility(problem5, 33).
utility(prntngArOK("Incorrect"), 22).
utility(prtSpool("Disabled"), -50).
utility(prtSpool("Enabled"), 17).
utility(tstpsTxt("x_1_Mb_Available_VM"), 7).
utility(trTypFnts, -47).
utility(fllCrrptdBffr("Full_or_Corrupt"), 21).
utility(prtPath("Incorrect"), 28).
utility(prtPort, -26).
utility(appOK("Correct"), 35).
utility(cblPrtHrdwrOK("Operational"), 17).
utility(pSERRMEM("Low_Memory"), -16).
utility(ntwrkCnfg("Correct"), 10).
utility(grphcsRltdDrvrSttngs("Incorrect"), -15).
utility(prtData, 6).
utility(prtMpTPth("Incorrect"), -40).
utility(prtStatMem("Out_of_Memory"), 13).
utility(prtPScript, -49).
utility(ePSGrphc("No____TIF___WMF___BMP_"), -47).
utility(prtFile, -48).
utility(prtMem("Less_than_2Mb"), 44).
utility(pgOrnttnOK("Correct"), 25).
utility(pC2PRT, 29).
utility(problem1("No_Output"), -31).
utility(pSGRAPHIC, 24).
utility(prtMem("Greater_than_2_Mb"), -35).
utility(dskLocal("Less_than_2_Mb"), 5).
utility(prtIcon("Normal"), 30).
utility(nnTTOK, -25).
utility(deskPrntSpd("OK"), 39).
utility(appDtGnTm("Too_Long"), -16).
utility(tstpsTxt("x_1_Mb_Available_VM2"), -24).
utility(prtPaper("No_Paper"), -16).
utility(lclGrbld, -38).
utility(fntInstlltn("Verified"), -25).
utility(appDtGnTm("Fast_Enough"), 15).
utility(prtStatMem("No_Error"), -13).
utility(prtThread("OK"), 22).
utility(dskLocal("Greater_than_2_Mb"), -21).
utility(deskPrntSpd("Too_Slow"), -46).
utility(drvSet("Correct"), 28).
utility(problem2("OK"), 31).
utility(prtThread("Corrupt_Buggy"), 22).
utility(prntPrcssTm("Too_Long"), -3).
utility(cblPrtHrdwrOK("Not_Operational"), -23).
utility(ntwrkCnfg("Incorrect"), 19).
utility(lclOK, -20).
utility(prtIcon("Grayed_Out"), 28).
utility(fllCrrptdBffr("Intact__not_Corrupt_"), 10).
utility(prtPaper("Has_Paper"), -17).
utility(prtSel, 7).
utility(cmpltPgPrntd, 44).
utility(avlblVrtlMmry("Adequate____1Mb_"), 33).
utility(tnrSpply("Adequate"), -19).
utility(problem4, 0).
utility(prtStatPaper("Jam__Out__Bin_Full"), -10).
utility(prtStatPaper("No_Error"), -12).
utility(grbldPS, 12).
utility(pgOrnttnOK("Incorrect"), 31).
utility(prntrAccptsTrtyp, 44).
utility(netPrint("No__Local_printer_"), -48).
utility(ntGrbld, -45).
utility(prtStatOff("OFFLINE__OFF"), 31).
utility(prtStatToner("Low__None"), -11).
utility(prtCbl("Loose"), 23).
utility(drvOK("Corrupt"), 33).
utility(dataFile("Correct"), -35).
utility(nnPSGrphc, 27).
utility(appOK("Incorrect_Corrupt"), 45).
