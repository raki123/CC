...
utility(grphcsRltdDrvrSttngs("Correct"), 17).
utility(prtDriver, 26).
utility(problem2("Too_Long"), -47).
utility(hrglssDrtnAftrPrnt("Too_Long"), -29).
utility(scrnFntNtPrntrFnt, -44).
utility(problem1("Normal_Output"), 22).
utility(tTOK, 48).
utility(drvSet("Incorrect"), 40).
utility(prntPrcssTm("Fast_Enough"), 40).
utility(hrglssDrtnAftrPrnt("Fast_Enough"), -38).
utility(dSApplctn("Windows"), -42).
utility(prtMpTPth("Correct"), -19).
utility(gDIIN, 9).
utility(dS_NTOK, -7).
utility(dataFile("Incorrect_Corrupt"), 34).
utility(pTROFFLINE("Online"), 33).
utility(eMFOK, -26).
utility(problem6, 7).
utility(prtStatOff("No_Error"), -32).
utility(prtQueue("Short"), 15).
utility(netPrint("Yes__Network_printer_"), 31).
utility(prtTimeOut("Too_Short"), 29).
utility(netOK, -13).
utility(prntngArOK("Incorrect"), -4).
utility(dS_LCLOK, -37).
utility(prtTimeOut("Long_Enough"), 28).
utility(prtSpool("Enabled"), -18).
utility(trTypFnts, 39).
utility(fllCrrptdBffr("Full_or_Corrupt"), 2).
utility(prtPath("Incorrect"), -30).
utility(appData("Correct"), 36).
utility(appOK("Correct"), -27).
utility(cblPrtHrdwrOK("Operational"), -20).
utility(pSERRMEM("Low_Memory"), -5).
utility(ntwrkCnfg("Correct"), 43).
utility(grphcsRltdDrvrSttngs("Incorrect"), 50).
utility(prtData, 34).
utility(prtMpTPth("Incorrect"), 41).
utility(ePSGrphc("No____TIF___WMF___BMP_"), 45).
utility(drvOK("Reinstalled"), -9).
utility(ntSpd("Slow"), -32).
utility(pC2PRT, -5).
utility(problem1("No_Output"), -37).
utility(pSGRAPHIC, 17).
utility(prtMem("Greater_than_2_Mb"), -5).
utility(dskLocal("Less_than_2_Mb"), 49).
utility(prtIcon("Normal"), -12).
utility(ntSpd("OK"), 45).
utility(nnTTOK, 29).
utility(deskPrntSpd("OK"), -21).
utility(appDtGnTm("Too_Long"), 45).
utility(tstpsTxt("x_1_Mb_Available_VM2"), 20).
utility(prtPaper("No_Paper"), 40).
utility(lclGrbld, 13).
utility(fntInstlltn("Verified"), -39).
utility(appDtGnTm("Fast_Enough"), -16).
utility(prtStatMem("No_Error"), 23).
utility(prtThread("OK"), -41).
utility(dskLocal("Greater_than_2_Mb"), -48).
utility(drvSet("Correct"), 38).
utility(problem2("OK"), -47).
utility(prtDataOut, -30).
utility(prtStatToner("No_Error"), 22).
utility(prtThread("Corrupt_Buggy"), 3).
utility(prntPrcssTm("Too_Long"), -8).
utility(cblPrtHrdwrOK("Not_Operational"), -15).
utility(ntwrkCnfg("Incorrect"), -15).
utility(pSERRMEM("No_Error"), -9).
utility(prtQueue("Long"), 0).
utility(problem3, 39).
utility(prtIcon("Grayed_Out"), 49).
utility(fllCrrptdBffr("Intact__not_Corrupt_"), -29).
utility(prtPaper("Has_Paper"), -8).
utility(cmpltPgPrntd, -47).
utility(avlblVrtlMmry("Adequate____1Mb_"), 11).
utility(tnrSpply("Adequate"), -29).
utility(problem4, -31).
utility(prtStatPaper("Jam__Out__Bin_Full"), 36).
utility(pTROFFLINE("Offline"), 12).
utility(grbldPS, -37).
utility(pgOrnttnOK("Incorrect"), -12).
utility(prtOn, 8).
utility(netPrint("No__Local_printer_"), -22).
utility(prtPath("Correct"), 38).
utility(prtStatOff("OFFLINE__OFF"), -10).
utility(tnrSpply("Low"), -28).
utility(prtStatToner("Low__None"), 42).
utility(prtCbl("Loose"), -27).
utility(drvOK("Corrupt"), 36).
utility(nnPSGrphc, 3).
utility(avlblVrtlMmry("Inadequate____1_Mb_"), 36).
utility(gDIOUT, 12).
