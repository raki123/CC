...
utility(\+(lowerBodyO2("12+")),-27).
utility(disease("Fallot"),24).
utility(cardiacMixing("Transp."),19).
utility(\+(cardiacMixing("Transp.")),45).
utility(cO2("Normal"),32).
utility(ductFlow("None"),39).
utility(\+(ductFlow("None")),-47).
utility(grunting,35).
utility(lVHreport,-15).
utility(chestXray("Grd_Glass"),-14).
utility(\+(chestXray("Grd_Glass")),30).
utility(gruntingReport,15).
utility(\+(gruntingReport),-27).
utility(cO2Report(">=7.5"),-26).
utility(\+(cO2Report(">=7.5")),37).
utility(cardiacMixing("Mild"),1).
utility(\+(lungParench("Normal")),2).
utility(\+(hypoxiaInO2("Moderate")),-46).
utility(\+(lungParench("Abnormal")),29).
...
utility(\+(hypDistrib("Unequal")),-8).
utility(disease("TAPVD"),-34).
utility(age("0-3_days"),-27).
utility(\+(age("0-3_days")),-33).
...
utility(\+(xrayReport("Plethoric")),-39).
utility(\+(chestXray("Oligaemic")),2).
utility(cO2Report("<7.5"),47).
utility(disease("TGA"),-33).
utility(xrayReport("Oligaemic"),16).
utility(\+(xrayReport("Oligaemic")),0).
utility(rUQO2("<5"),12).
utility(\+(rUQO2("<5")),-30).
...
utility(\+(cardiacMixing("None")),-45).
utility(lungFlow("Normal"),-20).
utility(\+(lungFlow("Normal")),-17).
utility(age("4-10_days"),2).
utility(\+(age("4-10_days")),-24).
...
0.15::lungParench("Abnormal") :- body_2482(2481,lungParench("Abnormal")).
0.7::sick :- body_2492(2491,sick).
0.85::lungFlow("Low") :- body_2502(2501,lungFlow("Low")).
0.1::ductFlow("Lt_to_Rt") :- body_2512(2511,ductFlow("Lt_to_Rt")).
0.0::ductFlow("None") :- body_2522(2521,ductFlow("None")).
0.1::age("4-10_days") :- body_2532(2531,age("4-10_days")).
0.15::hypoxiaInO2("Mild") :- body_2542(2541,hypoxiaInO2("Mild")).
0.05::hypDistrib("Unequal") :- body_2552(2551,hypDistrib("Unequal")).
0.95::hypDistrib("Equal") :- body_2562(2561,hypDistrib("Equal")).
0.6::rUQO2("5-12") :- body_2572(2571,rUQO2("5-12")).
