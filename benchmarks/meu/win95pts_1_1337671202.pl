...
utility(\+(prtMem("Greater_than_2_Mb")),33).
...
utility(\+(prtPath("Correct")),47).
utility(ntGrbld,-24).
utility(\+(ntGrbld),-46).
utility(prtStatOff("OFFLINE__OFF"),12).
utility(\+(prtStatOff("OFFLINE__OFF")),33).
...
utility(\+(drvOK("Corrupt")),44).
utility(dataFile("Correct"),28).
utility(\+(dataFile("Correct")),13).
utility(nnPSGrphc,-3).
