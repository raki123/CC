...
utility(\+(disease("Fallot")),-31).
utility(cO2("Normal"),16).
utility(\+(cO2("Normal")),27).
utility(ductFlow("None"),46).
utility(grunting,6).
utility(\+(grunting),27).
utility(\+(lVHreport),16).
utility(chestXray("Grd_Glass"),-31).
utility(\+(gruntingReport),16).
...
0.1::lVH :- body_2482(2481,lVH).
0.8::ductFlow("Lt_to_Rt") :- body_2492(2491,ductFlow("Lt_to_Rt")).
0.05::grunting :- body_2502(2501,grunting).
0.4::hypoxiaInO2("Severe") :- body_2512(2511,hypoxiaInO2("Severe")).
0.8::hypoxiaInO2("Severe") :- body_2522(2521,hypoxiaInO2("Severe")).
0.7::chestXray("Grd_Glass") :- body_2532(2531,chestXray("Grd_Glass")).
0.95::hypDistrib("Equal") :- body_2542(2541,hypDistrib("Equal")).
0.1::gruntingReport :- body_2552(2551,gruntingReport).
