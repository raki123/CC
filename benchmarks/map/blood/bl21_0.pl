...
0.3::mchrom(p_f_m_m_f,a); 0.3::mchrom(p_f_m_m_f,b); 0.4::mchrom(p_f_m_m_f,null).
0.3::pchrom(p_f_m_m_f,a); 0.3::pchrom(p_f_m_m_f,b); 0.4::pchrom(p_f_m_m_f,null).			
0.3::mchrom(p_f_m_m_m,a); 0.3::mchrom(p_f_m_m_m,b); 0.4::mchrom(p_f_m_m_m,null).
0.3::pchrom(p_f_m_m_m,a); 0.3::pchrom(p_f_m_m_m,b); 0.4::pchrom(p_f_m_m_m,null).			
0.3::mchrom(p_m_f_f_f,a); 0.3::mchrom(p_m_f_f_f,b); 0.4::mchrom(p_m_f_f_f,null).
0.3::pchrom(p_m_f_f_f,a); 0.3::pchrom(p_m_f_f_f,b); 0.4::pchrom(p_m_f_f_f,null).			
0.3::mchrom(p_m_f_f_m,a); 0.3::mchrom(p_m_f_f_m,b); 0.4::mchrom(p_m_f_f_m,null).
0.3::pchrom(p_m_f_f_m,a); 0.3::pchrom(p_m_f_f_m,b); 0.4::pchrom(p_m_f_f_m,null).			
0.3::mchrom(p_m_f_m_f,a); 0.3::mchrom(p_m_f_m_f,b); 0.4::mchrom(p_m_f_m_f,null).
0.3::pchrom(p_m_f_m_f,a); 0.3::pchrom(p_m_f_m_f,b); 0.4::pchrom(p_m_f_m_f,null).			
0.3::mchrom(p_m_f_m_m,a); 0.3::mchrom(p_m_f_m_m,b); 0.4::mchrom(p_m_f_m_m,null).
0.3::pchrom(p_m_f_m_m,a); 0.3::pchrom(p_m_f_m_m,b); 0.4::pchrom(p_m_f_m_m,null).			
0.3::mchrom(p_m_m_f_f,a); 0.3::mchrom(p_m_m_f_f,b); 0.4::mchrom(p_m_m_f_f,null).
0.3::pchrom(p_m_m_f_f,a); 0.3::pchrom(p_m_m_f_f,b); 0.4::pchrom(p_m_m_f_f,null).			
0.3::mchrom(p_m_m_f_m,a); 0.3::mchrom(p_m_m_f_m,b); 0.4::mchrom(p_m_m_f_m,null).
0.3::pchrom(p_m_m_f_m,a); 0.3::pchrom(p_m_m_f_m,b); 0.4::pchrom(p_m_m_f_m,null).			
0.3::mchrom(p_m_m_m_f,a); 0.3::mchrom(p_m_m_m_f,b); 0.4::mchrom(p_m_m_m_f,null).
0.3::pchrom(p_m_m_m_f,a); 0.3::pchrom(p_m_m_m_f,b); 0.4::pchrom(p_m_m_m_f,null).			
0.3::mchrom(p_m_m_m_m,a); 0.3::mchrom(p_m_m_m_m,b); 0.4::mchrom(p_m_m_m_m,null).
0.3::pchrom(p_m_m_m_m,a); 0.3::pchrom(p_m_m_m_m,b); 0.4::pchrom(p_m_m_m_m,null).			
0.3::mchrom(p_f_f_f_f_f,a); 0.3::mchrom(p_f_f_f_f_f,b); 0.4::mchrom(p_f_f_f_f_f,null).
0.3::pchrom(p_f_f_f_f_f,a); 0.3::pchrom(p_f_f_f_f_f,b); 0.4::pchrom(p_f_f_f_f_f,null).			
0.3::mchrom(p_f_f_f_f_m,a); 0.3::mchrom(p_f_f_f_f_m,b); 0.4::mchrom(p_f_f_f_f_m,null).
0.3::pchrom(p_f_f_f_f_m,a); 0.3::pchrom(p_f_f_f_f_m,b); 0.4::pchrom(p_f_f_f_f_m,null).			
0.3::mchrom(p_f_f_f_m_f,a); 0.3::mchrom(p_f_f_f_m_f,b); 0.4::mchrom(p_f_f_f_m_f,null).
0.3::pchrom(p_f_f_f_m_f,a); 0.3::pchrom(p_f_f_f_m_f,b); 0.4::pchrom(p_f_f_f_m_f,null).			
0.3::mchrom(p_f_f_f_m_m,a); 0.3::mchrom(p_f_f_f_m_m,b); 0.4::mchrom(p_f_f_f_m_m,null).
0.3::pchrom(p_f_f_f_m_m,a); 0.3::pchrom(p_f_f_f_m_m,b); 0.4::pchrom(p_f_f_f_m_m,null).			
0.3::mchrom(p_f_f_m_f_f,a); 0.3::mchrom(p_f_f_m_f_f,b); 0.4::mchrom(p_f_f_m_f_f,null).
0.3::pchrom(p_f_f_m_f_f,a); 0.3::pchrom(p_f_f_m_f_f,b); 0.4::pchrom(p_f_f_m_f_f,null).			
0.3::mchrom(p_f_f_m_f_m,a); 0.3::mchrom(p_f_f_m_f_m,b); 0.4::mchrom(p_f_f_m_f_m,null).
0.3::pchrom(p_f_f_m_f_m,a); 0.3::pchrom(p_f_f_m_f_m,b); 0.4::pchrom(p_f_f_m_f_m,null).			
0.3::mchrom(p_f_f_m_m_f,a); 0.3::mchrom(p_f_f_m_m_f,b); 0.4::mchrom(p_f_f_m_m_f,null).
0.3::pchrom(p_f_f_m_m_f,a); 0.3::pchrom(p_f_f_m_m_f,b); 0.4::pchrom(p_f_f_m_m_f,null).			
0.3::mchrom(p_f_f_m_m_m,a); 0.3::mchrom(p_f_f_m_m_m,b); 0.4::mchrom(p_f_f_m_m_m,null).
0.3::pchrom(p_f_f_m_m_m,a); 0.3::pchrom(p_f_f_m_m_m,b); 0.4::pchrom(p_f_f_m_m_m,null).			
0.3::mchrom(p_f_m_f_f_f,a); 0.3::mchrom(p_f_m_f_f_f,b); 0.4::mchrom(p_f_m_f_f_f,null).
0.3::pchrom(p_f_m_f_f_f,a); 0.3::pchrom(p_f_m_f_f_f,b); 0.4::pchrom(p_f_m_f_f_f,null).			
0.3::mchrom(p_f_m_f_f_m,a); 0.3::mchrom(p_f_m_f_f_m,b); 0.4::mchrom(p_f_m_f_f_m,null).
0.3::pchrom(p_f_m_f_f_m,a); 0.3::pchrom(p_f_m_f_f_m,b); 0.4::pchrom(p_f_m_f_f_m,null).			
0.3::mchrom(p_f_m_f_m_f,a); 0.3::mchrom(p_f_m_f_m_f,b); 0.4::mchrom(p_f_m_f_m_f,null).
0.3::pchrom(p_f_m_f_m_f,a); 0.3::pchrom(p_f_m_f_m_f,b); 0.4::pchrom(p_f_m_f_m_f,null).			
