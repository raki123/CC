...
map_query 1.0::algebraic_atom(27,2,0,set(none),mchrom(p,null),"0.4").
0.3::algebraic_atom(28,0,0,set(none),pchrom(p,a),"0.3").
map_query 0.42857143::algebraic_atom(28,1,0,set(none),pchrom(p,b),"0.3").
map_query 1.0::algebraic_atom(28,2,0,set(none),pchrom(p,null),"0.4").
ev :- bloodtype(p,a).
