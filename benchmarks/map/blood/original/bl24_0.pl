...
map_query 0.3::mchrom(p_m_f_f_m,a); 0.3::mchrom(p_m_f_f_m,b); 0.4::mchrom(p_m_f_f_m,null).
map_query 0.3::pchrom(p_m_f_f_m,a); 0.3::pchrom(p_m_f_f_m,b); 0.4::pchrom(p_m_f_f_m,null).			
