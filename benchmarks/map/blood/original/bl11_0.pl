...
map_query 0.3::mchrom(p_m_f_f,a); 0.3::mchrom(p_m_f_f,b); 0.4::mchrom(p_m_f_f,null).
map_query 0.3::pchrom(p_m_f_f,a); 0.3::pchrom(p_m_f_f,b); 0.4::pchrom(p_m_f_f,null).			
